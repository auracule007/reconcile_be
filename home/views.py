...
#                 system_a_data = self.process_csv(file_a)
#                 system_b_data = self.process_csv(file_b)
            
#             discrepancies = self.compare_systems(system_a_data, system_b_data)
...
#         discrepancies = []
#         common_ids = set(system_a.keys()) & set(system_b.keys())
        
#         # Missing in B
#         for trans_id in set(system_a.keys()) - common_ids:
#             discrepancies.append({
#                 'transaction_id': trans_id,
#                 'type': 'missing_in_b',
#                 'amount_a': system_a[trans_id]['amount'],
#                 'status_a': system_a[trans_id]['status'],
#                 'currency': system_a[trans_id]['currency']
#             })
        
#         # Missing in A
#         for trans_id in set(system_b.keys()) - common_ids:
#             discrepancies.append({
#                 'transaction_id': trans_id,
#                 'type': 'missing_in_a',
#                 'amount_b': system_b[trans_id]['amount'],
#                 'status_b': system_b[trans_id]['status'],
#                 'currency': system_b[trans_id]['currency']
#             })
